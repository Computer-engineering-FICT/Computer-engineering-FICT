 ...
 */
public class BeginActivityMouseListener extends BlockMouseListener implements Serializable {

    private static final long serialVersionUID = 2199786785007302291L;

    public BeginActivityMouseListener(AlgorithmPanel panel) {
        super(panel);
    }
            ...
            case MouseEvent.BUTTON1:
                ...
                if (e.getClickCount() == 1) {
                    if (!model.contains(e.getX(), e.getY())) {
                        model.addComponent(new BeginActivity(e.getX(), e.getY()));
                    } else {
