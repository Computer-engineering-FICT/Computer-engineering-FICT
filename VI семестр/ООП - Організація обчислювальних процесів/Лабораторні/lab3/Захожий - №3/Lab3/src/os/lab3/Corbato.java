...
public class Corbato {
    ...
    public String tactWithLog() {
        ...
        while (((double) t * lambda) > generateCount) {
            ...
            addProgram(p);
            generateCount++;
            log += "Добавлена программа с длиной Lp = " + String.valueOf(p.getLp()) + "\n";
        }
        while ((i < queues.size()) && (queues.get(i).getSize() == 0)) {
            i++;
        }
        ...
        if (i < queues.size()) {
            ...
            log += "Выполнение программы из очереди №" + String.valueOf(i) + " с длиной Lp = " +
        ...
        log += "Системное время: " + String.valueOf(t) + "\n";
        return log;
    }
