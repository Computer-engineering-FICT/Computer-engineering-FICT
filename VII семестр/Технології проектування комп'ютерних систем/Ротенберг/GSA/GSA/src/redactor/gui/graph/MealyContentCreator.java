...
public class MealyContentCreator {
    ...
    private  Data data;
    private List<Entity> listOfEntity;              //import from data
    private  List<String[]> automateTable;           //automateTable format: [from] [to] [conditions] [operations]
    private  int zCounter;                           //for numerating Z
    private   HashMap<Entity, Integer> associatedZ;   //if value != 0 before this vertex is Z-marker
    private  ArrayList<ArrayList<Entity>> listOfWays;  //ways (can include conditions and operations) between Z-markers
