...
public class TransitionAndMinimizatorTextCreator {
    TransitionData transitionData;
    List<KavaiForOneFunction> mimimiList;

    public TransitionAndMinimizatorTextCreator(TransitionData transitionData, List<KavaiForOneFunction> mimimiList) {
