...
public class BinaryMarkerCreator {
    List<String[]> automateTable;
    int zCounter;
    List<TreeVertex> treeVertexList;
    int sizeOfMarking;
    ...
    public BinaryMarkerCreator(List<String[]> automateTable, int zCounter) {
        ...
        for (int i = 0; i < automateTable.size(); i++) {
            for (int j = 0; j < automateTable.get(i).length; j++) {
                System.out.print(automateTable.get(i)[j]);
        }
            System.out.println();
        }
    ...
    public void useCreateMarking() {
        ...
        for (int i = 0; i < automateTable.size(); i++) {
            for (int j = 0; j < tableOfGraphConnections[i].length; j++) {
                System.out.print(tableOfGraphConnections[i][j] + " | ");
            }
            System.out.println();
        }
