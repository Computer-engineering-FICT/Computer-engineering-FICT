...
public class GSAModel {
    ...
    public static final int DEFAULT_ARROW_WIDTH = 20;
    public static final double DEFAULT_ARROW_ANGLE = 0.5;
    public static final int DEFAULT_CONNECTORS_SIZE = 6;
    public static final int DEFAULT_MARKING_SIZE = 10;
    
    public static final Color DEFAULT_ERROR_NODES_COLOR = Color.MAGENTA;
    public static final Color DEFAULT_ERROR_LINES_COLOR = Color.RED;
    public static final Color DEFAULT_MARKING_COLOR = Color.BLUE;

    private static final Color DEFAULT_BACKGROUND_COLOR = Color.WHITE;
    private static final Color DEFAULT_NET_COLOR = Color.LIGHT_GRAY;
    private static final Color DEFAULT_NODES_COLOR = Color.CYAN;
    private static final Color DEFAULT_LINES_COLOR = Color.BLACK;

    private static final int DEFAULT_NET_INTERVAL = 50;
    ...
    public void markForMooreAuromat() {
        isMarked = true;
    }

    public void clearMarkingForMooreAutomat() {
        isMarked = false;
    }

    public boolean isMarkedForMooreAutomat() {
        return isMarked;
    }
