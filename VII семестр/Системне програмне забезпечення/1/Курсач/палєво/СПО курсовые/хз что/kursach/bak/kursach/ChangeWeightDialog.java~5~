...
public class ChangeWeightDialog extends EmptyDialog {
        ...
        public ChangeWeightDialog(JFrame owner, Parametrized element) {
                ...
                if (element instanceof Node)
                    ...
                    setTitle("Введите время пересылки");
                pack();
        ...
        protected JPanel initControlsPanel() {
                ...
                if (element instanceof Node)
                    ...
                    weightLabel = new JLabel("Время пересылки: ");
        ...
        protected void approve() {
                if (!weightField.getText().equals("")) {
                        ...
                        try {
                            ...
                            if (element instanceof Node)
                                JOptionPane.showMessageDialog(this, "Введите целое значение веса",
                                                "Ошибка", JOptionPane.ERROR_MESSAGE);
                            else
                                JOptionPane.showMessageDialog(this, "Введите целое значение времени пересылки",
                                                "Ошибка", JOptionPane.ERROR_MESSAGE);
                                return;
                        }
