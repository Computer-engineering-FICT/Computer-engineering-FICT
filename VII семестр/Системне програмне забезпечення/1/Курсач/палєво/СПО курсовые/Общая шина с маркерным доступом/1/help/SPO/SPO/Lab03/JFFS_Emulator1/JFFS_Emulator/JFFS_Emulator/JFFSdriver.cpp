...
bool JFFSdriver::go;
unsigned int JFFSdriver::cId;
//void (JFFSdriver::*actions[])();
FILE* JFFSdriver::fs;
SpaceDescr JFFSdriver::sd;
PageDescr* JFFSdriver::pdt;
FileDescr* JFFSdriver::fdt;
Command* JFFSdriver::cm;
Command* JFFSdriver::ncm;
ChangeChain* JFFSdriver::chgs;
