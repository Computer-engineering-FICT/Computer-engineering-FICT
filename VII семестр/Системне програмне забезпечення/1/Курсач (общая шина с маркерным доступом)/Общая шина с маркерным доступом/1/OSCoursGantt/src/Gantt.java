...
{
  public Gantt(String paramString)
  {
    super(paramString);
  ...
  private static JFreeChart createChart(IntervalXYDataset paramIntervalXYDataset)
  {
    ...
    SymbolAxis localSymbolAxis = new SymbolAxis("Series", new String[] { "Team A", "Team B", "Team C", "Team D", "Test" });
  ...
  private static TaskSeriesCollection createTasks()
  {
    ...
    TaskSeries localTaskSeries5 = new TaskSeries("Test");
    localTaskSeries4.add(new Task("T5a", new Day()));
  ...
  {
    Gantt localXYTaskDatasetDemo1 = new Gantt("JFreeChart : XYTaskDatasetDemo1.java");
