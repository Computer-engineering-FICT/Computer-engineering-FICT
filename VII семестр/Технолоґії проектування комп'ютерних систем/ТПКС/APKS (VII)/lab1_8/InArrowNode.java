...
public class InArrowNode extends AbstractNode {

	private static final long serialVersionUID = 1L;
	
	private int currentNumber;

	public InArrowNode(int Number) {
	...
	public Point paint(Graphics2D g2, Point p) {
		...
		g2.draw(Arrow2D.getArrow(new Point((int)(getPosition().getX()+NBounds.getCenterX()), (int)(getPosition().getY()-NBounds.getHeight())), new Point((int)(getPosition().getX()+NBounds.getCenterX()), (int)getPosition().getY()), 8, 30));
