...
public class GSAPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        ArrayList<Node> nodesInInfiniteCycles = model.getNodesInInfiniteCycles();
        int z = 2;
        for (Node e : model.getNodes()) {
            Color colorBackup = e.getColor();
            if (nodesInInfiniteCycles.contains(e)) {
                e.setColor(GSAModel.DEFAULT_ERROR_NODES_COLOR);
            }
            if (e.getClass().getName().contains("BeginNode")) {
                drawBeginNode((BeginNode) e, model.isMarkedForMooreAutomat(), 1, g2);
            }
            else {
                if (e.getClass().getName().contains("OperatorNode")) {
                    drawOperatorNode((OperatorNode) e, model.isMarkedForMooreAutomat(), z++, g2);
                }
                else {
                    if (e.getClass().getName().contains("LogicNode")) {
                        ...
                        drawEndNode((EndNode) e, model.isMarkedForMooreAutomat(), 1, g2);
                    }
                }
            }
            if (nodesInInfiniteCycles.contains(e)) {
        ...
        for (Node e : model.getNodes()) {
            ...
            if (haveChildren) {
                Color backupColor = model.getLinesColor();
                if (e.getClass().getName().contains("BeginNode") || e.getClass().getName().contains("OperatorNode") || e.getClass().getName().contains("EndNode")) {
                    ...
                    if ((model.getNodesInInfiniteCycles().contains(e)) && (model.getNodesInInfiniteCycles().contains(child))) {
                                model.setLinesColor(GSAModel.DEFAULT_ERROR_LINES_COLOR);
                    }
                    ...
                    if (e.getClass().getName().contains("LogicNode")) {
                        ...
                        if (yesChild != null) {
                            if ((model.getNodesInInfiniteCycles().contains(e)) && (model.getNodesInInfiniteCycles().contains(yesChild))) {
                                model.setLinesColor(GSAModel.DEFAULT_ERROR_LINES_COLOR);
                            }
                        ...
                        if (noChild != null) {
                            if ((model.getNodesInInfiniteCycles().contains(e)) && (model.getNodesInInfiniteCycles().contains(noChild))) {
                                model.setLinesColor(GSAModel.DEFAULT_ERROR_LINES_COLOR);
                            }
                            else {
                                model.setLinesColor(backupColor);
                            }
                ...
                if (model.getNodesInInfiniteCycles().contains(e)) {
                    model.setLinesColor(backupColor);
                }
            }
        }
        ...
        model.removeNodesInInfiniteCycles();
    }
    ...
    private void drawOperatorNode(OperatorNode node, boolean isMarked, int z, Graphics2D g2) {
        ...
        g2.fillRect(node.getX() + (node.getWidth() - GSAModel.DEFAULT_CONNECTORS_SIZE) / 2, node.getY() + node.getHeight() - GSAModel.DEFAULT_CONNECTORS_SIZE / 2,
                GSAModel.DEFAULT_CONNECTORS_SIZE, GSAModel.DEFAULT_CONNECTORS_SIZE);
        if (isMarked) {
            g2.setColor(GSAModel.DEFAULT_MARKING_COLOR);
            g2.fillOval(node.getX() + node.getWidth() - GSAModel.DEFAULT_MARKING_SIZE / 2,
                    node.getY() + node.getHeight() / 2 - GSAModel.DEFAULT_MARKING_SIZE / 2,
                    GSAModel.DEFAULT_MARKING_SIZE, GSAModel.DEFAULT_MARKING_SIZE);
            String markingText = "Z" + String.valueOf(z);
            bounds = DEFAULT_FONT.getStringBounds(markingText, context);
            x = node.getX() + node.getWidth() + GSAModel.DEFAULT_MARKING_SIZE;
            y = node.getY() + node.getHeight() / 2 + bounds.getHeight() / 2;
            g2.drawString(markingText, (int) x, (int) y);
        }
    }
    ...
    private void drawBeginNode(BeginNode node, boolean isMarked, int z, Graphics2D g2) {
        g2.setColor(node.getColor());
    ...
    private void drawEndNode(EndNode node, boolean isMarked, int z, Graphics2D g2) {
        g2.setColor(node.getColor());
        g2.fillOval(node.getX(), node.getY(), node.getHeight(), node.getHeight());
        g2.fillOval(node.getX() + node.getWidth() - node.getHeight(), node.getY(), node.getHeight(), node.getHeight());
        g2.fillRect(node.getX() + node.getHeight() / 2, node.getY(), node.getWidth() - node.getHeight(), node.getHeight());
                ...
                if (!model.isInNode(e.getX(), e.getY())) {
                    if (model.getActionType() == 1) {
                        try {
                            ...
                            model.clearMarkingForMooreAutomat();
                            repaint();
                    ...
                    if (model.getActionType() == 5) {
                        if ((model.getNodeInEntrance(e.getX(), e.getY()) == null) && (model.getLogicNodeInExit(e.getX(), e.getY()) == null)
                                && (model.getNotLogicNodeInExit(e.getX(), e.getY()) == null)) {
