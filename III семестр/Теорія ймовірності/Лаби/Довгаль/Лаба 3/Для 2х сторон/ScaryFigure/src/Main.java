...
public class Main {
    ...
    public static String doAllmyWork(double A, double B, double Delta) throws Exception{
        ...
        answrer.append("Текущее значение стороны B - "+ b+ "\n");
        answrer.append("Соответственно значение высоты H - "+ 3/(a*b)+ "\n");
