...
::
:: The JVM options below set the initial Java heap size to 256 Mb
:: and allow extending it up to 512 Mb.
::----------------------------------------------------------------------
...
::----------------------------------------------------------------------
:: Specify the XML Type Configuration Files used in demo samples
::----------------------------------------------------------------------
set DOCFLEX_OPTIONS=-xmltype "%DFH%\samples\personal\personal.xmltype;%DFH%\samples\sales\sales.xmltype"

::----------------------------------------------------------------------
:: Launch Template Designer
:: (Note: double quotes are needed because file pathnames may contain spaces)
::----------------------------------------------------------------------
"%JAVA_HOME%\bin\java" %JAVA_OPTIONS% -cp "%CLASS_PATH%" com.docflex.xml.Designer %DOCFLEX_OPTIONS%
