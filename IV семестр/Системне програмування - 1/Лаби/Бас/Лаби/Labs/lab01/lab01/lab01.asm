...
.data
	Caption0 db "CPUID 0 Vendor string", 0
	...
	Text0 db	"Vendor:", 0ah, 0dh, 
				"xxxxxxxxxxxx", 0ah, 0dh, 
				"Max cpuid command : xxxxxxxx", 0

	Text2 db	"EAX=xxxxxxxx", 0ah, 0dh,
				"EBX=xxxxxxxx", 0ah, 0dh,
				"ECX=xxxxxxxx", 0ah, 0dh,
				"EDX=xxxxxxxx", 0
	
	Text3 db	"xxxxxxxxxxxxxxxx", 0ah, 0dh,
				"xxxxxxxxxxxxxxxx", 0ah, 0dh,
				"xxxxxxxxxxxxxxxx", 0
