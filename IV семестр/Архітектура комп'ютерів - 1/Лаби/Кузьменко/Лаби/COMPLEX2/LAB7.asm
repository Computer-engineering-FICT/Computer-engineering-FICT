...
link rb:z,7,6,5
\------------commands------------\
dw 0:0011000000110010%         \ read from ZP
dw 1:0011100010110010%
dw 2:0010000000000000%         \ cond jump
dw 3:0001100001010000%         \ mult
dw 4:1000110000100010%         \ plus (2 adr)
dw 5:0010100000000000%         \ uncond jump    
dw 6:0000010000000000%
\----------const M----------------\
dw 50h:500
dw 51h:1
dw 52h:500
