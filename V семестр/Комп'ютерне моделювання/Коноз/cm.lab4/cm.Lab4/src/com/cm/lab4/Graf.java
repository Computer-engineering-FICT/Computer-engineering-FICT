...
public class Graf {
	...
	public void config() {
		...
		Device nourthBridge = new Device(2, 0, 0, 1, "ϳ������ ���", 19.0);
		Device southBridge = new Device(3, 0, 0, 1, "ϳ������� ���", 65.0);
		Device ram = new Device(4, 0, 0, 1, "Ram", 0.5);
		Device videoProc = new Device(5, 0, 0, 1, "³��� ��������", 68);
	...
	public void buildTree() {
		...
		System.out.println("C���� " + uniqueStates.size());
		System.out.println("�������� " + uniqueArcs.size());
	...
	public void calcLoadingDevice() {
		...
		System.out.println("���� ����          "+String.format("%3.15f", loading[1]));
		System.out.println("��� ����           "+String.format("%3.15f", loading[0]));
		System.out.println("ϳ������ ���     "+String.format("%3.15f", loading[2]));
		System.out.println("ϳ������� ���     "+String.format("%3.15f", loading[3]));
		System.out.println("���������� ���*��� "+String.format("%3.15f", loading[4]));
		System.out.println("³��� ��������     "+String.format("%3.15f", loading[5]));
		
		uniqueStates.get(200).printState();
		System.out.println();
