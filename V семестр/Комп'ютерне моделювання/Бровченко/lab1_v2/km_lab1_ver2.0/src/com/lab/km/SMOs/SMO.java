...
public abstract class SMO {
    ...
    public void start() {
        ...
        double averageTimeInSystem = this.calculateTimeIsSystem();
        double averageDispersion = this.calculateDispersion(averageTimeInSystem);
        double timeOfReaction = this.calculateTimeOfReaction();
    ...
    protected double calculateTimeIsSystem() {
        double result = 0;
    ...
    protected double calculateDispersion(double averageTimeInSystem) {
        double result = 0;
        for (Task task : this.archive) {
    ...
    protected double calculateTimeOfReaction() {
        double result= 0;
        for (Task task : this.archive) {
