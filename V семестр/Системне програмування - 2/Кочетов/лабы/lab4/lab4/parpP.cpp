...
{nil,ptrm,//_nil, _nam,	//0 зовнішнє подання
 ...
 pbkw,nil,nil,nil,//_continue, _repeat, _untilN, _endloop, //16 continue repeat until
 ...
 nil,nil,//_tdbr, _tcbr,	// відкриті і закриті дужки даних 6
 ...
 pmul,nil,nil,nil,//_mod, _orB, _andB, _xorB,		// %(mod) |(or) &(and) ^(xor) 
 pshf,pshf,nil,nil,//_shLft,_shRgt, _or, _and,	//<<(shl) >>(shr) ||(or) &&(and)    
 nil,nil,nil,nil,//_xmrk,_invB,_divI,_in, //_not, _notB, /(div)
...
enum tokPrec opPrGP[290]= 
{nil,ptrm,//_nil, _nam,	//0 зовнішнє подання
 ptrm,ptrm,//_srcn,	_cnst,	//2 вхідне і внутрішнє кодування константи
 peos,peos,peos,nil,//_if,_then,_else,_elseif,	//4 if then else elseif
 nil,nil,nil,nil,//_case, _switch, _default, _endcase,//8 case switch defualt endcase
 pbkw,pskw,peos,nil,//_break, _return, _whileP, _whileN, //12 break return while do
 pbkw,nil,nil,nil,//_continue, _repeat, _untilN, _endloop, //16 continue repeat until
 peos,peos,nil,nil,//_for, _to, _downto, _step,// for to downto step 
 nil,nil,nil,nil,//_untilP, _loop, _with, _endif,	
 nil,nil,nil,nil, nil,nil,nil,nil,
 //_goto,_extern,_var,_const,_enum,_struct/*_record*/,_union,_register,//
 nil,nil,nil,nil, nil,nil,nil,nil,
