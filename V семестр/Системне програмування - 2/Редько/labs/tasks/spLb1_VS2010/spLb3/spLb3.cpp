...
{{_nam, (struct lxNode*)imgs[1], NULL, 0, 0, 0, 0, 0, NULL, 0},
{ _if,  &pic3[0], &pic3[3], 0, 0, 0, 0, 0, NULL, 0},
{ _nam, (struct lxNode*)imgs[3], NULL, 0, 0, 0, 0, 0, NULL, 0},
{ _brkt,&pic3[2], NULL, 0, 0, 0, 0, 0, NULL, 0},
{ _else,&pic3[1], &pic3[6], 0, 0, 0, 0, 0, NULL, 0},//4
{ _nam, (struct lxNode*)imgs[5], NULL, 0, 0, 0, 0, 0, NULL, 0},
{ _brkt,&pic3[5], NULL, 0, 0, 0, 0, 0, NULL, 0},
};
//{ _EOS, &token[25], &token[13], 0, 0, 0, 0, 0, NULL, 0},
...
struct lxNode pic15[]= //do--n;while(n&&b==a[n]);
{{_endloop,&pic15[4], NULL, 0, 0, 0, 0, 0, NULL, 0},
 {_nam,(struct lxNode*)imgs[1], NULL, 0, 0, 0, 0, 0, NULL, 0},
 {_dcr, /*&pic5[1]*/NULL, &pic15[3], 0, 0, 0, 0, 0, NULL, 0},
 {_nam,(struct lxNode*)imgs[8], NULL, 0, 0, 0, 0, 0, NULL, 0},
 {_whileN, &pic15[2], &pic15[6], 0, 0, 0, 0, 0, NULL, 0},
 {_nam,(struct lxNode*)imgs[8], NULL, 0, 0, 0, 0, 0, NULL, 0},
 {_and, &pic15[5], &pic15[8], 0, 0, 0, 0, 0, NULL, 0},	//10
 {_nam,(struct lxNode*)imgs[0], NULL, 0, 0, 0, 0, 0, NULL, 0},
 {_eq, &pic15[7], &pic15[10], 0, 0, 0, 0, 0, NULL, 0},
 {_nam,(struct lxNode*)imgs[1], NULL, 0, 0, 0, 0, 0, NULL, 0},
 {_ixbr, &pic15[9], &pic15[3], 0, 0, 0, 0, 0, NULL, 0},
{_EOS, &pic15[0], &pic15[12], 0, 0, 0, 0, 0, NULL, 0},
