...
// модифікатори
#define cdPtr  0x10000	// код покажчика 1-го рівня
#define cdCns  0x8000	// код константного типу даних
#define cdArr  0x08000	// код даних типу масиву 
#define cdCna  0x88000	// код константного масиву
#define cdReg  0x10000	// код регістрового типу даних
#define cdExt  0x20000	// код зовнішнього типу даних
#define cdStt  0x30000	// код статичного типу даних
#define cdAut  0x40000	// код автоматичного типу даних
enum datType
...
{enum tokType kTp[3];// примірник структури ключа
 enum datType dTp;// примірник функціональної частини
...
enum datType SmAnlzr(struct lxNode * nd,	// вказівник на початок масиву вузлів 
