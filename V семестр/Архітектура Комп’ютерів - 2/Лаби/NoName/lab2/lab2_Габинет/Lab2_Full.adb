...
package body User_Package_Full is
...
--IV-91, FIVT
--Tserkus Andrey 
--Lab 2 User_Full_Package using program
--20/09/01
--
--Variant: 1)05 2)05 3)26
--Part 1) C = SORT(A) + SORT(B);
...
with Ada.Text_Io; use Ada.Text_Io;      
with Ada.Integer_Text_Io; use Ada.Integer_Text_Io;      
with User_Package_Full; use User_Package_Full;

procedure Lab2_Full is 
   --Global definitions
   N_Here: T_Index;
