package main.java.com.yUvOsIl.lab3;
...
public class Lab3
{
    ...
    {
        int c3 = 5318 % 3; // String
        int c17 = 5318 % 17; // В кожному слові заданого тексту, видалити всі наступні входження першої літери цього слова
