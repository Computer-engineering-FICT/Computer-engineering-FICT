 ...
 * @author Glushko Olga
 */
public class Assistant extends Academic implements Scientist {

	private final static String RANK = "None";
	 ...
	 * @param name
	 */
	public Assistant(String surname, String name) {
		super(surname, name);
		academicRank = RANK;
	}
	 ...
	 * @param position
	 */
	public Assistant(String surname, String name, String facultee,
	 ...
	 */
	public Assistant(String surname, String name, String facultee,
			String cathedra, String position, String degree) {
		super(surname, name, facultee, cathedra, position);
		academicRank = RANK;
	...
	public boolean canPromotePosition() {
		return (((academicDegree.compareTo("Candidate of science") == 0) || (academicDegree.compareTo("Doctor") == 0)) && (publicationsNumber > 1));
	}
