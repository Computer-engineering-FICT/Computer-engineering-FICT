...
public class Laba4 {
	...
	public static String FACULTEES[] = { "", "", "", "" };
	public static String CATHEDRAS[] = { "", "", "", "" };
	...
	public static void main(String[] args) {
		...
		/* to use comparator class replace following line with:
		 * Arrays.sort(academics, new AcademicComparator());
		 */
		sort(academics);
		...
		System.out.println();
		/* to use comparator class replace following line with:
		 * Arrays.sort(academics, new AcademicAlphabeticalComparator());
		 */
		...
		System.out.println();
		/* to use comparator class replace following line with:
		 * Arrays.sort(academics, new AcademicAgeComparator());
		 */
		sortByAge(academics);
		...
		System.out.println();
		/* to use comparator class replace following line with:
		 * Arrays.sort(academics, new AcademicPositionComparator());
		 */
