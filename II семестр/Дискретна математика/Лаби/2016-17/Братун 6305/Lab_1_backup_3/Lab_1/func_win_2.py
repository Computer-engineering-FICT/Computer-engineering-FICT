...
def open_toplevel_next_step(event):
    ...
    def step3(event):
        global result1
        result1 = (func.U - func.A | func.A) & func.A
    ...
    def step4(event):
        global result1
        result1 = ((func.U - func.A | func.A) & func.A) - func.B
    ...
    def step5(event):
        global result1
        result1 = (((func.U - func.A | func.A) & func.A) - func.B) | func.B
    ...
    def step8(event):
        global result2
        result2 = func.U - ((func.C & func.B) | func.C)
        printed = '¬(C ^ B) v C) = ' + str(result2)
        top = Toplevel(height=500, width=100, relief = GROOVE)
        top.title("Step 8\n ¬((C ^ B) v C)")
        tex = Text(top,width=180, height=20,font="Verdana 12",wrap=WORD)
    ...
    def step9(event):
        ...
        global result1
        global result2
        D = ((((func.U - func.A | func.A) & func.A) - func.B) | func.B) & (func.U - ((func.C & func.B) | func.C))
        printed = 'D = ' + str(D)
        top = Toplevel(height=500, width=100, relief = GROOVE)
