from tkinter import *
import func,window2, window3, window4, window5
from  tkinter import messagebox


root = Tk()
root.title("Main Window")
root.maxsize(width=895,height=615)
root.minsize(width=895,height=615)
...
lab5 = Label(root, text='Create random set\n(elements from 0 to 255):', font='arial 20')
