...
def create_window_3():
   ...
   but6 = Button(window3, text="See set D", font='arial 20')
   but6.bind("<Button-1>", func_win_3.see_set_D)
   but7 = Button(window3, text="Save set D", font='arial 20')
   but7.bind("<ButtonRelease-1>", func_win_3.save_set_D)
