...
function TInp9Form.factorial (n:integer):integer;
var i:Integer;
begin
 if n =1 then factorial:=1 else factorial:=n*factorial(n-1);
end;

procedure TInp9Form.ExitButtonClick(Sender: TObject);
begin
  Close;
end;

procedure TInp9Form.a_ButtonClick(Sender: TObject);
var ind,i,k:Integer;
...
procedure TInp9Form.BinListBoxClick(Sender: TObject);
Var Elem:String;
begin
...
procedure TInp9Form.ClearButtonClick(Sender: TObject);
var i:Integer;
begin
 StartListBox.Clear;
 aListBox.Clear;
...
procedure TInp9Form.ComLenLabelClick(Sender: TObject);
begin

end;

procedure TInp9Form.Label5Click(Sender: TObject);
begin

end;

procedure TInp9Form.LoadParamButtonClick(Sender: TObject);
begin
 LoadParam;
end;

procedure TInp9Form.Memo1Change(Sender: TObject);
begin

end;

procedure TInp9Form.NamesListBoxClick(Sender: TObject);
var NewElem:String;
...
procedure TInp9Form.SaveParamButtonClick(Sender: TObject);
begin
  SaveParam;
end;
...
procedure TInp9Form.s_ButtonClick(Sender: TObject);
begin
 InfoPanel.Caption:='';
 If m_Edit.Text>'' then
 begin
