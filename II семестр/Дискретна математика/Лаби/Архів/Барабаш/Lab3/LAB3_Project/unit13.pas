...
procedure TInp13Form.ExitButtonClick(Sender: TObject);
begin
  Close;
end;
...
procedure TInp13Form.vListBoxClick(Sender: TObject);
Var ind:Integer;
    i:Integer;
begin
...
procedure TInp13Form.ClearButtonClick(Sender: TObject);
var i:Integer;
begin
 StartListBox.Clear;
 aListBox.Clear;
...
procedure TInp13Form.FormActivate(Sender: TObject);
Var    i:Integer;
begin
...
procedure TInp13Form.FormCreate(Sender: TObject);
begin
  ParamPath:=ExtractFilePath(Application.ExeName);
end;

procedure TInp13Form.ComLenLabelClick(Sender: TObject);
begin

end;

procedure TInp13Form.Label5Click(Sender: TObject);
begin

end;

procedure TInp13Form.LoadParamButtonClick(Sender: TObject);
begin
 LoadParam;
end;

procedure TInp13Form.Memo1Change(Sender: TObject);
begin

end;

procedure TInp13Form.NamesListBoxClick(Sender: TObject);
var NewElem:String;
...
procedure TInp13Form.SaveParamButtonClick(Sender: TObject);
begin
  SaveParam;
end;
...
procedure TInp13Form.s_ButtonClick(Sender: TObject);
begin
 InfoPanel.Caption:='';
 If m_Edit.Text>'' then
 begin
 ...
 procedure TInp13Form.LoadParam;
Var F : Text;
    ...
    PVS:String;
begin
ParamFileName:=ParamPath+'DATA\P13.txt';
 ...
 procedure TInp13Form.SaveParam;
 Var F : Text;
     ParamFileName:String;
     sNumElements:String;
