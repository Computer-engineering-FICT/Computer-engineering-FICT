...
type
  ...
  TInpForm = class(TForm)
    ...
    procedure BRadioButtonChange(Sender: TObject);
    ...
    procedure WPanelClick(Sender: TObject);
   private
...
procedure TInpForm.WPanelClick(Sender: TObject);
begin
...
procedure TInpForm.BRadioButtonChange(Sender: TObject);
begin
