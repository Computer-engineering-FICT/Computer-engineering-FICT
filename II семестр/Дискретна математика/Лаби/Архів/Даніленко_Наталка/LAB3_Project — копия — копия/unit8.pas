...
function TInp8Form.factorial (n:integer):integer;
var i:Integer;
begin
 if n =1 then factorial:=1 else factorial:=n*factorial(n-1);
end;

procedure TInp8Form.ExitButtonClick(Sender: TObject);
begin
  Close;
end;

procedure TInp8Form.InDatButtonClick(Sender: TObject);
var sInpDate:String;
    i,p:Integer;
    Pr:String;
...
procedure TInp8Form.ComLenLabelClick(Sender: TObject);
begin

end;

procedure TInp8Form.LoadParamButtonClick(Sender: TObject);
begin
 LoadParam;
end;

procedure TInp8Form.SaveParamButtonClick(Sender: TObject);
begin
  SaveParam;
end;


procedure TInp8Form.s_ButtonClick(Sender: TObject);
begin
 InfoPanel.Caption:='';
 If m_Edit.Text>'' then
 begin
