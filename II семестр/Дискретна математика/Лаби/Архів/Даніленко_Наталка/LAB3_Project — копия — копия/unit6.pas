...
function TInp6Form.factorial (n:integer):integer;
var i:Integer;
begin
 if n =1 then factorial:=1 else factorial:=n*factorial(n-1);
end;

procedure TInp6Form.ExitButtonClick(Sender: TObject);
begin
  Close;
end;

procedure TInp6Form.a_ButtonClick(Sender: TObject);
var ind,i,k:Integer;
...
procedure TInp6Form.ClearButtonClick(Sender: TObject);
var i:Integer;
begin
 StartListBox.Clear;
 aListBox.Clear;
...
procedure TInp6Form.ComLenLabelClick(Sender: TObject);
begin

end;

procedure TInp6Form.Label5Click(Sender: TObject);
begin

end;

procedure TInp6Form.LoadParamButtonClick(Sender: TObject);
begin
 LoadParam;
end;

procedure TInp6Form.Memo1Change(Sender: TObject);
begin

end;

procedure TInp6Form.NamesListBoxClick(Sender: TObject);
var NewElem:String;
...
procedure TInp6Form.SaveParamButtonClick(Sender: TObject);
begin
  SaveParam;
end;
...
procedure TInp6Form.s_ButtonClick(Sender: TObject);
begin
 InfoPanel.Caption:='';
 If m_Edit.Text>'' then
 begin
...
Var F : Text;
    ...
    PVS:String;
begin
ParamFileName:=ParamPath+'DATA\P6.txt';
