...
type
  ...
  TInp5Form = class(TForm)
    ...
    procedure EdgeButton1Click(Sender: TObject);
...
procedure TInp5Form.Button1Click(Sender: TObject);
Var dWeight:Integer;
begin
 ...
 // IMatrixGrid.Cells[CurCol,CurRow]:=EdgeEdit.Text; // Запись числа в выбранную ячейку
  ...
  //else InfoPanel.Caption:='Наберіть вагу ребра і натисніть "ВВІД"';
...
procedure TInp5Form.EdgeButton1Click(Sender: TObject);  // Вод ребер
Var dWeight:Integer;
begin
